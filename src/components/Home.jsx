  ...
  return (
    ...
    >
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row text-white">
        <div className="flex flex-col justify-center h-full mt-[70px]">
          ...
          <p className="text-gray-500 py-4 max-w-md">
            ...
            a hunger for continuous learning. I`m actively seeking opportunities
            to grow and thrive in the ever-evolving tech landscape
          </p>
          <div>
            <Link
              to="project"
